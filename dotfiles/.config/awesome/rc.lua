...
clientkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "c",      function (c) c.kill(c)  end),
    awful.key({ modkey, "Control" }, "space",  awful.client.floating.toggle                     ),
    awful.key({ modkey, "Control" }, "Return", function (c) c.swap(c, awful.client.getmaster()) end),
    awful.key({ modkey,           }, "o",      awful.client.movetoscreen                        ),
    awful.key({ modkey, "Shift"   }, "r",      function (c) c.redraw(c)                       end),
